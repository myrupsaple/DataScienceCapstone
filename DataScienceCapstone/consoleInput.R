consoleInput <- function(){
        ...
        write.csv(gdata, 'Output/01_PrePreprocessed/Blogs Single Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Two Word Counts...')
        gdata <- countTwo(fdata)
        write.csv(gdata, 'Output/01_PrePreprocessed/Output/Blogs Two Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Three Word Counts...')
        gdata <- countMany(fdata, n = 3)
        write.csv(gdata, 'Output/01_PrePreprocessed/Output/Blogs Three Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Four Word Counts...')
        gdata <- countMany(fdata, n = 4)
        write.csv(gdata, 'Output/01_PrePreprocessed/Output/Blogs Four Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Five Word Counts...')
        gdata <- countMany(fdata, n = 5)
        write.csv(gdata, 'Output/01_PrePreprocessed/Output/Blogs Five Word Counts.csv', row.names = FALSE)
        rm(fdata, gdata)
        ...
        gdata <- countWords(fdata)
        write.csv(gdata, 'Output/01_PrePreprocessed/News Single Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Two Word Counts...')
        gdata <- countTwo(fdata)
        write.csv(gdata, 'Output/01_PrePreprocessed/News Two Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Three Word Counts...')
        gdata <- countMany(fdata, n = 3)
        write.csv(gdata, 'Output/01_PrePreprocessed/News Three Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Four Word Counts...')
        gdata <- countMany(fdata, n = 4)
        write.csv(gdata, 'Output/01_PrePreprocessed/News Four Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Five Word Counts...')
        gdata <- countMany(fdata, n = 5)
        write.csv(gdata, 'Output/01_PrePreprocessed/News Five Word Counts.csv', row.names = FALSE)
        rm(fdata, gdata)
        ...
        gdata <- countWords(fdata)
        write.csv(gdata, 'Output/01_PrePreprocessed/Twitter Single Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Two Word Counts...')
        gdata <- countTwo(fdata)
        write.csv(gdata, 'Output/01_PrePreprocessed/Twitter Two Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Three Word Counts...')
        gdata <- countMany(fdata, n = 3)
        write.csv(gdata, 'Output/01_PrePreprocessed/Twitter Three Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Four Word Counts...')
        gdata <- countMany(fdata, n = 4)
        write.csv(gdata, 'Output/01_PrePreprocessed/Twitter Four Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Five Word Counts...')
        gdata <- countMany(fdata, n = 5)
        write.csv(gdata, 'Output/01_PrePreprocessed/Twitter Five Word Counts.csv', row.names = FALSE)
        rm(fdata, gdata)
        ...
        data <- read.csv('Output/01_PrePreprocessed/Blogs Single Word Counts.csv', colClasses = c('character', 'numeric'))
        clean <- filter(data, twoOrMoreWords = FALSE)
        write.csv(clean, 'Output/02_Cleaned/Blogs Single Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Blogs Two Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Blogs Two Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Blogs Two Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Blogs Three Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Blogs Three Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Blogs Three Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Blogs Four Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Blogs Four Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Blogs Four Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Blogs Five Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Blogs Five Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Blogs Five Word Counts.csv', row.names = FALSE)
        rm(data, clean)
        ...
        data <- read.csv('Output/01_PrePreprocessed/News Single Word Counts.csv', colClasses = c('character', 'numeric'))
        clean <- filter(data, twoOrMoreWords = FALSE)
        write.csv(clean, 'Output/02_Cleaned/News Single Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning News Two Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/News Two Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/News Two Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning News Three Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/News Three Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/News Three Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning News Four Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/News Four Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/News Four Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning News Five Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/News Five Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/News Five Word Counts.csv', row.names = FALSE)
        rm(data, clean)
        ...
        data <- read.csv('Output/01_PrePreprocessed/Twitter Single Word Counts.csv', colClasses = c('character', 'numeric'))
        clean <- filter(data, twoOrMoreWords = FALSE)
        write.csv(clean, 'Output/02_Cleaned/Twitter Single Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Twitter Two Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Twitter Two Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Twitter Two Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Twitter Three Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Twitter Three Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Twitter Three Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Twitter Four Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Twitter Four Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Twitter Four Word Counts.csv', row.names = FALSE)
        rm(clean)
        print('Cleaning Twitter Five Word Counts...')
        data <- read.csv('Output/01_PrePreprocessed/Twitter Five Word Counts.csv', colClasses = c('character', 'character', 'numeric'))
        clean <- filter(data)
        write.csv(clean, 'Output/02_Cleaned/Twitter Five Word Counts.csv', row.names = FALSE)
        rm(data, clean)
        ...
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Blogs Two Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Blogs Three Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Blogs Four Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Blogs Five Word Counts2.csv', row.names = FALSE)
        rm(data, cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/News Two Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/News Three Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/News Four Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/News Five Word Counts2.csv', row.names = FALSE)
        rm(data, cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Twitter Two Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Twitter Three Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Twitter Four Word Counts2.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        write.csv(cleaner, 'Output/04a_TopThree_Separate/Twitter Five Word Counts2.csv', row.names = FALSE)
        rm(data, cleaner)
        ...
        write.csv(merged, 'Output/03_Merged/Master Single Word Counts.csv', row.names = FALSE)
        rm(merged)
        ...
        rm(blogs, news, twitter)
        write.csv(merged, 'Output/03_Merged/Master Two Word Counts.csv', row.names = FALSE)
        rm(merged)
        ...
        merged <- mergeSets(blogs, news, twitter)
        rm(blogs, news, twitter)
        write.csv(merged, 'Output/03_Merged/Master Three Word Counts.csv', row.names = FALSE)
        rm(merged)
        ...
        merged <- mergeSets(blogs, news, twitter)
        rm(blogs, news, twitter)
        write.csv(merged, 'Output/03_Merged/Master Four Word Counts.csv', row.names = FALSE)
        rm(merged)
        ...
        merged <- mergeSets(blogs, news, twitter)
        rm(blogs, news, twitter)
        write.csv(merged, 'Output/03_Merged/Master Five Word Counts.csv', row.names = FALSE)
        rm(merged)
        ...
        cleaner <- topThree(data)
        rm(data)
        write.csv(cleaner, 'Output/04b_TopThree_Merged/Master Two Word Counts.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        rm(data)
        write.csv(cleaner, 'Output/04b_TopThree_Merged/Master Three Word Counts.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        rm(data)
        write.csv(cleaner, 'Output/04b_TopThree_Merged/Master Four Word Counts.csv', row.names = FALSE)
        rm(cleaner)
        ...
        cleaner <- topThree(data)
        rm(data)
        write.csv(cleaner, 'Output/04b_TopThree_Merged/Master Five Word Counts.csv', row.names = FALSE)
        rm(cleaner)
