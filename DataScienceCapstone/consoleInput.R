consoleInput <- function(){
        ...
        write.csv(gdata, 'Output/01_PreProcessed/Blogs Single Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Two Word Counts...')
        gdata <- countTwo(fdata)
        write.csv(gdata, 'Output/01_PreProcessed/Blogs Two Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Three Word Counts...')
        gdata <- countMany(fdata, n = 3)
        write.csv(gdata, 'Output/01_PreProcessed/Blogs Three Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Four Word Counts...')
        gdata <- countMany(fdata, n = 4)
        write.csv(gdata, 'Output/01_PreProcessed/Blogs Four Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Blogs Five Word Counts...')
        gdata <- countMany(fdata, n = 5)
        write.csv(gdata, 'Output/01_PreProcessed/Blogs Five Word Counts.csv', row.names = FALSE)
        rm(fdata, gdata)
        ...
        gdata <- countWords(fdata)
        write.csv(gdata, 'Output/01_Preprocessed/News Single Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Two Word Counts...')
        gdata <- countTwo(fdata)
        write.csv(gdata, 'Output/01_Preprocessed/News Two Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Three Word Counts...')
        gdata <- countMany(fdata, n = 3)
        write.csv(gdata, 'Output/01_Preprocessed/News Three Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Four Word Counts...')
        gdata <- countMany(fdata, n = 4)
        write.csv(gdata, 'Output/01_PreProcessed/News Four Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding News Five Word Counts...')
        gdata <- countMany(fdata, n = 5)
        write.csv(gdata, 'Output/01_PreProcessed/News Five Word Counts.csv', row.names = FALSE)
        rm(fdata, gdata)
        ...
        gdata <- countWords(fdata)
        write.csv(gdata, 'Output/01_PreProcessed/Twitter Single Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Two Word Counts...')
        gdata <- countTwo(fdata)
        write.csv(gdata, 'Output/01_PreProcessed/Twitter Two Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Three Word Counts...')
        gdata <- countMany(fdata, n = 3)
        write.csv(gdata, 'Output/01_PreProcessed/Twitter Three Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Four Word Counts...')
        gdata <- countMany(fdata, n = 4)
        write.csv(gdata, 'Output/01_PreProcessed/Twitter Four Word Counts.csv', row.names = FALSE)
        rm(gdata)
        print('Finding Twitter Five Word Counts...')
        gdata <- countMany(fdata, n = 5)
        write.csv(gdata, 'Output/01_PreProcessed/Twitter Five Word Counts.csv', row.names = FALSE)
        rm(fdata, gdata)
